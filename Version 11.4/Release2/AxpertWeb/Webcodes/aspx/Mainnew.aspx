...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../Js/common.min.js?v=154"></script>
    <script src="../Js/process.min.js?v=326"></script>
    ...
    <script type="text/javascript" src="../js/main.min.js?v=315"></script>
</head>
